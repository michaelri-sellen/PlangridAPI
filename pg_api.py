...
import json # Required to format JSON API responses as Python objects

# Initialize ConfigParser and open config.txt
config = configparser.ConfigParser()
config.readfp(open('config.txt'))

# Set auth to the API key from config.txt and headers to the default headers 
#expected by the Plangrid API
