...
# Takes a date string in ISO-8601 format, parses it as a python datetime object, shifts the timezone from UTC
# to the local timezone of the computer running this script, and formats the time as MM/DD/YYYY H:M
